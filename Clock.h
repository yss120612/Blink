...
public:
	Time_() {};
	Time_(uint16_t yr, uint8_t mon, uint8_t date,uint8_t hr, uint8_t min, uint8_t sec);
	Time_(uint16_t yr, uint8_t mon, uint8_t date, uint8_t hr, uint8_t min, uint8_t sec, uint8_t day);
...
public:
	...
	void setDurations(uint16_t minutes) {
		//start = clock.time();
...
private:
	static const uint8_t kRamSize = 31;
